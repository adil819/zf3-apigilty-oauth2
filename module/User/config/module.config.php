...
return [
    ...
    'service_manager' => [
        'factories' => [
            ...
            'user.activate-room' => \User\V1\Service\ActivateRoomFactory::class,
            ...
            'user.activate-room.listener' => \User\V1\Service\Listener\ActivateRoomEventListenerFactory::class,
