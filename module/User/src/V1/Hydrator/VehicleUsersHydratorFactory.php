 ...
 */
class VehicleUsersHydratorFactory implements FactoryInterface
{
    /**
    ...
    public function __invoke(ContainerInterface $container, $requestedName, array $options = null)
    {
        ...
        $hydrator->addStrategy('bookingDay', new DateTimeFormatterStrategy('c'));
        ...
        $hydrator->addStrategy('vehicle', new \User\V1\Hydrator\Strategy\VehicleStrategy);
        //UNCOMMENT JIKA MAU PAKE HYDRATOR STRATEGY
